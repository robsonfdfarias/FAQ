        ...
        ?>
            <ul id="menu">
                ...
                <a href="index.php">
                    ...
                    <li <?php $checa->retorna('sei') ?>><a href="sei.php">O que é o sei</a></li>
                    <li <?php $checa->retorna('mapa') ?>><a href="mapa.php">Mapa</a></li>
                    <li <?php $checa->retorna('capacitacao') ?>><a href="capacitacao.php">Capacitação</a></li>
                    <li <?php $checa->retorna('legislacao') ?>><a href="legislacao.php">Legislação</a></li>
                    <li <?php $checa->retorna('coisasParaSaberSei') ?>><a href="coisasParaSaberSei.php">Curiosidades sobre o SEI</a></li>
                    <li <?php $checa->retorna('declaracaoUtilidadePublica') ?>><a href="declaracaoUtilidadePublica.php">Declaração de Utilidade Pública</a></li>
                    <li <?php $checa->retorna('perguntasFrequentes') ?>><a href="perguntasFrequentes.php">Perguntas frequentes</a></li>
            </ul>
        </nav>
    </div>
