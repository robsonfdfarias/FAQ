...
<body>
    ...
    <div id="geral">
        <div id="central">
            ...
            <div id="avisogeral">
                <div id="avisoCentral">
                    <h1>Alerta!!!</h1>
                    <h3>Você tem certeza que deseja excluir o artigo com titulo:<br> <span id="tt"><?php echo $obj->getTitulo(); ?></span>
                        <br>E resumo:<br> <span id="tt"><?php echo substr($obj->getResumo(), 0, 200); ?>...</span>
                    </h3>
                    <table width="100%">
                        <tr>
    ...
    <script type="text/javascript">
        ...
        function excluir(){
            ...
            //alert(id.innerText);
            window.open("noticiaDelete.submit.php?id="+id.innerText);
        }
        function cancelar(){
            window.close();
        }
